...
selectTag.forEach((tag, id) => {
    for (const country_code in countries) {
        //selecting English by default as FROM language and hindi as TO languages
         let selected;
...
translateBtn.addEventListener("click", () => {
   ...
   //fetching api response and return  it with passing into js obj and in  another then method receiving that obj
